...
public class infixToPrefix {
    //1. Reverse the string of infix form 
    //2. Perform the Postfix conversion with one condition of converting closing bracket to opening bracket and opening bracket convertrd to closing bracket
    //3. Reverse the answer to get the prefix 
...
(getPriority(infix.charAt(i)) <=
 getPriority(char_stack.peek()) &&
  ...
  static String infiToPrefix(char[] infix) {
    /*
  ...
  public static void main(String[] args) {
    ...
    System.out.print(infiToPrefix(s.toCharArray()));
  }
}
